...
//                fillTable();
   ...
   public void fillTablePGHOff() {
        ...
        try {
            ...
            for (PhieuGiaoHang phieugiaohang_OFF : list) {
                ...
                Object[] row = {
                   ...
                   phieugiaohang_OFF.getTrangThaiHD()
                };
                model.addRow(row);
                index++;
            }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tblPGHNgungHoatDong);
...
//            this.row = tblPGHNgungHoatDong.rowAtPoint(evt.getPoint());
//            edit();
//        } else if (evt.getClickCount() == 2) {
//            int row = tblPGHNgungHoatDong.getSelectedRow();
//            int MaHoaDon = (int) tblPGHNgungHoatDong.getValueAt(row, 1);
