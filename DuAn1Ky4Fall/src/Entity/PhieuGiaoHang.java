...
public class PhieuGiaoHang {
    ...
    public PhieuGiaoHang(int MaPhieuGiaoHang, int MaHoaDon, int MaDonViVanChuyen, String TenNguoiNhan, String SoDienThoaiNguoiNhan, String DiaChiNhanHang, boolean HinhThucThanhToan, Date NgayGiaoHang, Date NgayNhanHang, String TrangThaiGiaoHang, boolean TinhTrangPGH, double TongGiaTriPGH, String GhiChuPGH, String TrangThaiHD) {
