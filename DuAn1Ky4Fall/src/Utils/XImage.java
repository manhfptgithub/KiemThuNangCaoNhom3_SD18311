...
public class XImage {
    ...
    public static void save(File src) {
        File dst = new File("C:\\DuAn1_Nhom1\\logos\\", src.getName());
...
//            src.getAbsolutePath()
    ...
    public static ImageIcon read(String fileName) {
        File path = new File("C:\\DuAn1_Nhom1\\logos\\", fileName);
        return new ImageIcon(path.getAbsolutePath());
    }

    public static void saveTH(File src) {
        File dst = new File("C:\\DuAn1_Nhom1\\logosTH\\", src.getName());
        if (!dst.getParentFile().exists()) {
            dst.getParentFile().mkdirs();
        }
        try {
//            src.getAbsolutePath()
    ...
    public static ImageIcon readTH(String fileName) {
        File path = new File("C:\\DuAn1_Nhom1\\logosTH\\", fileName);
        return new ImageIcon(path.getAbsolutePath());
    }
}
