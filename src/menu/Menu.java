...
public class Menu extends JComponent {
    ...
    private String[][] menuItems = new String[][]{
        {"Áo Khoác Mùa Đông","Thông Tin Áo Khoác"},      
        {"Hoá đơn","Bán Hàng","Danh Sách Hóa Đơn"},
        {"Khách Hàng","Thông Tin Khách Hàng","Lịch Sử Mua Hàng","Gửi Email"},
        {"Nhân viên", "Thông Tin Nhân Viên","Số Lượng Bán Hàng"},
        {"Phiếu giảm giá","Tạo Phiếu Giảm Giá","Lịch Sử Sử Dụng"},
        {"Đợt giảm giá"},
        {"Phiếu giao hàng","Thông Tin Phiếu Giao Hàng","Phiếu Giao Hàng Đã Xóa", },
        {"Phiếu đổi","Thông Tin Phiếu Đổi","Danh Sách Phiếu Đổi"},
        {"Thống kê", "Thống Kê Doanh Thu","Thống Kê Nhân Viên","Thống Kê Sản Phẩm"},
        {"Đổi Mật Khẩu"},
        {"Đăng Xuất"},
       };
