...
//        llv.setID(Integer.parseInt(txtID.getText()));
    ...
    void deleteLLV(){
     ...
     void fillTableNguoiDung(){
        SimpleDateFormat sd = new SimpleDateFormat("dd-MM-yyyy");
        DefaultTableModel tblModel = (DefaultTableModel) this.tblTaiKhoan.getModel();
        tblModel.setRowCount(0);
        try { 
            NDlist = NDDao.selectND(tblNhanVien.getValueAt(row, 0).toString());
            for (NguoiDung nd : NDlist) {
                Object[] row = new Object[4];
                row[0] = nd.getMaNhanVien();
                row[1] = nd.getTenDangNhap();
                row[2] = nd.getMatKhau();
                row[3] = nd.isVaiTro() ? "Quản lý" : "Nhân viên";
                tblModel.addRow(row);
            }
        } catch (Exception e) {
            MsgBox.alert(this, "Lỗi truy vấn dữ liệu");
...
//        llv.setID(Integer.parseInt(txtID.getText()));
        ...
        nd.setMaNhanVien(txtManv.getText());
        return nd;
    }
    
    void insertND(){
        NguoiDung nd = getModelND();
        try {
            NDDao.insert(nd);
    ...
    public void setModelND(NguoiDung nd){
        txtManv.setText(nd.getMaNhanVien());
    ...
    void editND(){
        try {
            ...
            NguoiDung nd = NDDao.selectById(maNV);
            if (nd != null) {
                setModelND(nd);
    ...
    private void initComponents() {
        ...
        buttonGroup2.add(rdoNam5);
        rdoNam5.setText("Nam");

        buttonGroup2.add(rdoNu5);
        rdoNu5.setText("Nữ");

        buttonGroup3.add(rdoHD5);
        rdoHD5.setText("Đang làm");

        buttonGroup3.add(rdoNHD5);
        ...
        jLabel18.setText("Tìm kiếm mã nhân viên");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtManv, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGap(4, 4, 4)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtTaikhoan, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(71, 71, 71)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jTabbedPane1.addTab("Thiết lập tài khoản", jPanel2);
    ...
    private void tblNhanVienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblNhanVienMouseClicked
        ...
        SimpleDateFormat sd = new SimpleDateFormat("dd-MM-yyyy");
        DefaultTableModel tblModel = (DefaultTableModel) this.tblLicLamViec.getModel();
        DefaultTableModel tblModel2 = (DefaultTableModel) this.tblTaiKhoan.getModel();
        tblModel.setRowCount(0);
        tblModel2.setRowCount(0);
        int row = tblNhanVien.getSelectedRow();
        int row2 = tblNhanVien.getSelectedRow();
        list = LLVDao.selectLLV(tblNhanVien.getValueAt(row, 0).toString());
        NDlist = NDDao.selectND(tblNhanVien.getValueAt(row2, 0).toString());
        txtNV.setText(tblNhanVien.getValueAt(row, 0).toString());
        ...
        try {
            ...
            for (NguoiDung nd : NDlist) {
                ...
                row3[0] = nd.getMaNhanVien();
                row3[1] = nd.getTenDangNhap();
                row3[2] = nd.getMatKhau();
                row3[3] = nd.isVaiTro()? "Quản lý" : "Nhân viên";
